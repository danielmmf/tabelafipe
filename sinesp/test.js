...
var marcas = [ { name: 'AUDI', fipe_name: 'Audi', order: 2, key: 'audi-6', id: 6 },
  ...
  { name: 'BABY',
    ...
    key: 'baby-207',
    id: 207 },
  { name: 'BRM', fipe_name: 'BRM', order: 1, key: 'brm-8', id: 8 },
  { name: 'BUGRE',
    fipe_name: 'Bugre',
    order: 1,
    key: 'bugre-123',
  ...
  { name: 'JINBEI',
    ...
    key: 'jinbei-154',
    id: 154 },
  { name: 'JPX', fipe_name: 'JPX', order: 1, key: 'jpx-30', id: 30 },
  { name: 'LADA',
    fipe_name: 'Lada',
    order: 1,
    key: 'lada-32',
  ...
  { name: 'MERCURY',
    ...
    key: 'mercury-40',
    id: 40 },
  { name: 'MG', fipe_name: 'MG', order: 1, key: 'mg-167', id: 167 },
  { name: 'MINI',
    fipe_name: 'MINI',
    order: 1,
    key: 'mini-156',
  ...
  { name: 'WALK',
    ...
    var modelo = 'FORD/FIESTA HA 1.5L S';

var dados_carro = modelo.split('/');

for (var i = marcas.length - 1; i >= 0; i--) {
	if(dados_carro[0] == marcas[i].name){
		console.log(marcas[i].name);
		console.log(marcas[i].id);
	}
}
//console.log(marcas);
